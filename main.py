"""SprintGPT entry point.

By default this launches the SprintGPT web app:
...
def run_web(host: str, port: int, open_browser: bool) -> None:
    ...
    print(f"SprintGPT is running at {url}  (press Ctrl+C to stop)")
    if open_browser:
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Launch the SprintGPT web app.")
